    ...
    <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-6 flex flex-col items-center text-center relative overflow-hidden">
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
          Trove is your intelligent sanctuary for wisdom. Organize your library, capture insights
          with AI, and join the elite Circle of readers.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
          <Link href="/signup">
            <Button
              size="lg"
              className="h-16 px-12 rounded-full text-xl font-black italic shadow-[0_20px_40px_-12px_rgba(var(--primary),0.4)] hover:scale-105 active:scale-95 transition-all bg-primary group"
            >
              Start Your Journey
          ...
          <Link href="#features">
            <Button
              variant="outline"
              size="lg"
              className="h-16 px-10 rounded-full text-lg font-bold border-2 hover:bg-primary/5"
            >
              See Features
            </Button>
          </Link>
        ...
        >
          {[
            ...
            <div
              key={i}
              className="flex items-center justify-center gap-2 font-black uppercase tracking-widest text-[10px]"
            >

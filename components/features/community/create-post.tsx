...
export function CreatePost({ user, communityId, onPostCreated }: { user: any, communityId: string, onPostCreated: () => void }) {
                        ...
                        {isExpanded && (
                            ...
                            >
                                ...
                                <div className="flex gap-3">
                                    <Button variant="ghost" className="rounded-full" onClick={() => setIsExpanded(false)}>Cancel</Button>
                                    <Button

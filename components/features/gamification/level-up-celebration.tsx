...
export function LevelUpCelebration() {
  ...
  const celebrate = (newLevel: number) => {
    ...
    celebrationDiv.className =
      'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[200] bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 text-white px-12 py-8 rounded-2xl shadow-2xl animate-in zoom-in-95 duration-700 text-center border-4 border-white/20';

...
export function DailyGoalCelebration() {
  ...
  const celebrate = () => {
    ...
    celebrationDiv.className =
      'fixed top-20 left-1/2 -translate-x-1/2 z-50 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full shadow-2xl animate-in slide-in-from-top-5 duration-500 flex items-center gap-3';

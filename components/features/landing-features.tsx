...
import { BarChart3, Highlighter, Shield, Sparkles, Upload, Users, Zap } from 'lucide-react';
      ...
      <div className="container mx-auto px-8">
        <div className="text-center mb-24 space-y-4">
          ...
          <h2 className="text-5xl md:text-6xl font-black tracking-tighter">
            Everything to{' '}
            <span className="italic opacity-50 underline decoration-primary/30">Ascend.</span>
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10 space-y-6">
                <div
                  className={`w-16 h-16 rounded-[1.5rem] bg-background shadow-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}
                >

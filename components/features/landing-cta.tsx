            ...
            >
                ...
                <div className="relative z-10 space-y-10">
                    ...
                    <p className="text-white/80 text-xl md:text-2xl font-medium max-w-2xl mx-auto">
                        Stop merely reading. Start absorbing. Join the elite who use Trove to conquer their library.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
                        <Link href="/signup">
                            <Button size="lg" className="h-20 px-12 rounded-full text-2xl font-black italic bg-white text-primary hover:bg-white/90 hover:scale-105 active:scale-95 transition-all shadow-2xl">
                                Claim User ID

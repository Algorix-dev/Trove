...
export function BookSummary({ bookTitle, bookAuthor }: BookSummaryProps) {
        ...
        <Card className="p-6">
            ...
            {!summary && !loading && (
                <div className="text-center py-8">
                    ...
                    <Button onClick={generateSummary} className="bg-gradient-to-r from-purple-500 to-blue-500">

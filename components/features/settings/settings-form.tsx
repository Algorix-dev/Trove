...
import { Bell, Check, Loader2, Shield, Target, Upload, User } from 'lucide-react';
              ...
              <Card className="border-none shadow-2xl bg-card/60 backdrop-blur-xl rounded-[3rem] overflow-hidden">
                <CardHeader className="p-10 pb-0">
                  ...
                  <CardDescription className="text-lg">
                    How you manifest in the knowledge pool.
                  </CardDescription>
                </CardHeader>
                      ...
                      <div className="grid grid-cols-5 gap-3">
                        {PRESET_AVATARS.map((avatar) => (
                          <button
                            ...
                            className={`aspect-square rounded-xl border-4 transition-all relative overflow-hidden group ${
                ...
                <div className="space-y-8">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Define the intensity of your daily exploration.
                    </p>
                  </div>
                    ...
                    <div className="flex justify-between items-end">
                      <div className="space-y-2">
                        ...
                        <div className="text-6xl font-black text-primary italic">
                          {dailyGoal}{' '}
                          <span className="text-2xl text-muted-foreground not-italic">MINS</span>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm font-bold text-primary">Focus Level</p>
                        <p className="text-2xl font-black italic">
                          {dailyGoal >= 60 ? 'Scholar' : dailyGoal >= 30 ? 'Seeker' : 'Scout'}
                        </p>
                      </div>
                    </div>
                    <input
                  ...
                  <div className="flex items-center justify-between group">
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground italic">
                        Real-time alerts for the Circle and your progress.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between opacity-50 group">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <h4 className="text-xl font-black text-muted-foreground">
                          Dream Summaries
                        </h4>
                      ...
                      <p className="text-muted-foreground italic">
                        Weekly digests of your reading lore via raven.
                      </p>
                    </div>

    ...
    <Card>
      <CardHeader>
        ...
        <div className="flex gap-6 text-sm text-muted-foreground mt-2">
          ...
          <div>
            <span className="font-semibold text-foreground">{currentStreak}</span> day current
            streak
          </div>
          <div>
            <span className="font-semibold text-foreground">{longestStreak}</span> day longest
            streak
          </div>
        </div>
      </CardHeader>
